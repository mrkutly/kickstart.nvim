...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sg', multigrep.live_multigrep, { desc = '[S]earch by [G]rep' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('grk', vim.lsp.buf.hover, 'Show type info')
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = {
        ...
        -- 'super-tab' forshiftwidth tab to accept
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      local parsers = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'ruby', 'typescript', 'tsx', 'vim', 'vimdoc' }
